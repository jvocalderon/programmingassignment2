...
/**
 Base class for all interface views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the interface view hierarchy (such as wrapped iOS UIViews) was touched.
