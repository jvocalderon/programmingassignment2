...
// in simulator we redefine to format for interface Developer console
...
{\
	NSString * exceptionName = [@"org.interface." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.interface";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIinterfaceNativeItemNone = -1, 
	UIinterfaceNativeItemSpinner = -2,
	UIinterfaceNativeItemProgressBar = -3,
	
	UIinterfaceNativeItemSlider = -4,
	UIinterfaceNativeItemSwitch = -5,
	UIinterfaceNativeItemMultiButton = -6,
	UIinterfaceNativeItemSegmented = -7,
	
	UIinterfaceNativeItemTextView = -8,
	UIinterfaceNativeItemTextField = -9,
	UIinterfaceNativeItemSearchBar = -10,
	
	UIinterfaceNativeItemPicker = -11,
	UIinterfaceNativeItemDatePicker = -12,
	
	UIinterfaceNativeItemInfoLight = -13,
	UIinterfaceNativeItemInfoDark = -14,
	
	UIinterfaceNativeItemDisclosure = -15,
	
	UIinterfaceNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all interface instances of
