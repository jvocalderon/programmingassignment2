...
@interface interfaceObject : KrollCoverageObject {
#else
@interface interfaceObject : KrollObject {
#endif
@private
...
extern NSString * interface$ModuleRequireFormat;
